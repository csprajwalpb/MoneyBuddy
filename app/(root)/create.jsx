            ...
            <View style={styles.card}>
                <View style={styles.typeSelector}>
                    ...
                    onPress={()=>setIsExpense(true)}>
                        <Ionicons
                        name='arrow-down-circle' size={22} style={styles.typeIcon}
                    ...
                    onPress={()=>setIsExpense(false)}>
                        <Ionicons
                        name='arrow-up-circle' size={22} style={styles.typeIcon}
                ...
                <View style={styles.categoryGrid}>
                    {CATEGORIES.map(category=>(
                        <TouchableOpacity key={category.id} style={[
                            styles.categoryButton, selectedCategory===category.name && styles.categoryButtonActive,
                        ]} onPress={()=>setSelectedCategory(category.name)}>
                            <Ionicons name={category.icon} size={20} color={selectedCategory===category.name?COLORS.white:COLORS.text}
                            style={styles.categoryIcon} />
                            <Text style={[
                                styles.categoryButtonText, selectedCategory===category.name &&styles.categoryButtonTextActive,
                            ]}>{category.name}</Text>
                        </TouchableOpacity>
                    ))}
